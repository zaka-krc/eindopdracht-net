...
namespace SuntoryManagementSystem_Web
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,CustomerName,Address,PostalCode,City,PhoneNumber,Email,ContactPerson,CustomerType,Status,CreatedDate,Notes,IsDeleted,DeletedDate")] Customer customer)
        {
